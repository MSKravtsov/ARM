...
export default function PulseFab() {
    const { psychosocialData, setPsychosocialData, psychosocialRisk, profile, report } = useReport();
            ...
            <AnimatePresence>
                {!isExpanded && (
                    <motion.button
                        ...
                        className={`fixed bottom-8 right-8 flex items-center gap-2 px-5 py-3 rounded-full shadow-lg z-50 group transition-all
                            bg-slate-800 text-white hover:bg-slate-700 border-2 ${currentColors.ring}`}
                    >
                        <Activity className="w-5 h-5 group-hover:animate-pulse" />
                        <span className="font-semibold tracking-wide">Pulse Check</span>
                    </motion.button>
                )}
            </AnimatePresence>
                ...
                {isExpanded && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed z-50 md:top-24 md:right-8 md:left-auto md:w-[420px] md:max-h-[calc(100vh-12rem)] md:rounded-3xl bottom-0 left-0 right-0 rounded-t-3xl max-h-[85vh] overflow-y-auto bg-white/90 backdrop-blur-xl shadow-2xl border border-white/20"
                        >
                            {/* Header */}
                            <div className="flex items-center justify-between p-6 border-b border-slate-200/50">
                                <div className="flex items-center gap-3">
                                    <div className={`w-3 h-3 rounded-full ${currentColors.bg} animate-pulse`} />
                                    <h2 className="text-lg font-bold text-slate-800">Stress & Balance</h2>
                                </div>
                                <button
                                    onClick={() => setIsExpanded(false)}
                            ...
                            <div className={`mx-6 mt-4 p-3 rounded-xl ${currentColors.bgLight}`}>
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase ${currentColors.bg} text-white`}>
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-2">
                                        <input
                                            ...
                                            className="w-full h-3 rounded-full appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                                            style={{
                                ...
                                <div className="space-y-3">
                                            ...
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 px-4 py-2.5 rounded-xl font-medium text-sm transition-all ${
                                                        psychosocialData.sleepDuration === option.value
                                    ...
                                    {/* Energy */}
                                    <div className="space-y-2">
                                        <span className="text-xs font-medium text-slate-600">Energy</span>
                                        <div className="flex gap-2">
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 px-4 py-2.5 rounded-xl font-medium text-sm transition-all ${
                                                        psychosocialData.energyLevel === option.value
                                                            ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30'
                                                            : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                                                    }`}
                                                >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center gap-3">
                                            <span className="text-xs text-slate-600 w-20">Target GPA</span>
                                            <input
                                                type="number"
                                                min="1.0"
                                                max="4.0"
                                                ...
                                                className="flex-1 px-4 py-2.5 rounded-xl bg-slate-100 border-2 border-transparent focus:bg-white focus:border-orange-500 focus:outline-none text-sm font-medium transition-all"
                                            />
                                        </div>
                                        <div className="flex items-center gap-3">
                                            <span className="text-xs text-slate-600 w-20">Projected</span>
                                        ...
                                        {psychosocialRisk.gpaGap > 0.5 && (
                                            ...
                                            >
                                                <div className="flex items-start gap-2">
                                                    <span className={psychosocialRisk.hasUnrealisticExpectations ? 'text-red-600' : 'text-amber-600'}>
                                                        {psychosocialRisk.hasUnrealisticExpectations ? '⚠️' : '⚡'}
                                                    </span>
                                                    <span className={`text-xs font-medium ${
                                                        psychosocialRisk.hasUnrealisticExpectations ? 'text-red-700' : 'text-amber-700'
                                                    }`}>
                                                        {psychosocialRisk.hasUnrealisticExpectations
                                ...
                                {profile && profile.subjects.length > 0 && (
                                    <div className="space-y-3">
                                        ...
                                        <select
                                            ...
                                            className="w-full px-4 py-3 rounded-xl bg-slate-100 border-2 border-transparent focus:bg-white focus:border-orange-500 focus:outline-none text-sm font-medium transition-all"
                                        >
